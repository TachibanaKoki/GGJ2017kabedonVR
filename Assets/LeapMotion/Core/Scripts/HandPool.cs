...
namespace Leap.Unity {
  ...
  public class HandPool : MonoBehaviour {
    ...
    public class ModelGroup {
      ...
      //[HideInInspector]
      public List<IHandModel> modelList = new List<IHandModel>();  // !!! added initialization !!!
      //[HideInInspector]
      public List<IHandModel> modelsCheckedOut = new List<IHandModel>();  // !!! added initialization !!!
      public bool IsEnabled = true;
      public bool CanDuplicate;

      public Hands.HandEvent HandPostProcesses = new Hands.HandEvent();  // !!! added initialization !!!
